...
namespace motion_planning
{
	...
	void AStar::initialize_graph(const Eigen::MatrixXi& grid,
							   const Eigen::Vector2i& start,
							   const Eigen::Vector2i& goal)
	{
	...
	void AStar::find_valid_neighbors(const shared_ptr<Node> current_node,
	...
	bool AStar::search_path(const Eigen::Vector2i& start,
						  const Eigen::Vector2i& goal,
						  vector<Eigen::Vector2i>& path)
	{
		path.clear();
